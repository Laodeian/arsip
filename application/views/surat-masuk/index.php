            ...
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <!--disini kita akan menambahkan fitur download file Excel dan pdf-->
                            <?= form_open('sm/hapus_multiple', ['id' => 'formHapusSm']); ?>
                            <div class="card-header py-3">
                                <a href="<?= base_url('surat-masuk/tambah'); ?>" class="btn btn-primary shadow-sm btn-sm-block">
                                <i class="fas fa-fw fa-plus"></i> Tambah Data</a>
