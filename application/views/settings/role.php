...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <!-- Notifikasi berhasil (flashdata session) -->
                ...
                <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12">
                    ...
                    <div class="card shadow">
                        <div class="card-header">
                            <!-- Tombol membuka modal tambah role -->
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <!-- Perulangan data role dari database -->
                                    <?php foreach ($role as $num => $r) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- Tombol membuka modal ubah role -->
                                                <button type="button" data-toggle="modal" data-target="#ubahRole" data-id="<?= $r['id']; ?>" data-role="<?= $r['role']; ?>" 
                                                class=" btn btn-sm btn-warning btn-modal btn-ubah">ubah</button>

                                                <!-- Tombol membuka modal hapus role -->
                                                <a href="" data-toggle="modal" data-target="#modalHapus" 
                                                class="btn btn-sm btn-danger btn-hapus" data-id="<?= $r['id']; ?>">hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
