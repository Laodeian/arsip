    ...
    <div class="row mt-3">
        <div class="col-xl-8 col-lg-8 col-md-19 col-sm-12">
            ...
            <div class="card border-left-info shadow-sm my-3 p-4">
                ...
                <!-- Informasi peringatan sebelum melakukan backup/restore -->
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <!-- Form untuk proses Backup Database -->
                        <form action="<?= base_url('database/backup'); ?>" method="POST">
                            <input type="hidden" name="filterby" value="semua">

                            <button type="submit" name="backup" class="btn btn-primary btn-block shadow-sm mb-1">
                                <i class="fa fa-fw fa-cloud-download-alt"></i> BACK UP
                            </button>
                        </form>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <button type="button" data-toggle="modal" data-target="#modalRestore" class="btn btn-primary btn-block shadow-sm">
                            <i class="fa fa-fw fa-cloud-upload-alt"></i> Restore
                        </button>
                    </div>
...
<div class="modal fade" id="modalRestore" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <!-- Form untuk proses Restore Database -->
