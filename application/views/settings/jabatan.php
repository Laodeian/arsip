...
<div class="container-fluid">
    ...
    <!-- Notifikasi flashdata jika ada pesan -->
    <div class="row">
        <div class="col-md-12">
                                    ...
                                    <?php foreach ($jabatan as $num => $j) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- Tombol untuk membuka modal ubah -->
                                                <button type="button" data-toggle="modal" data-target="#ubahJabatan" data-id="<?= $j['id']; ?>" data-nama="<?= $j['nama']; ?>" 
                                                data-jabatan="<?= $j['jabatan']; ?>" class="btn btn-sm btn-warning btn-modal btn-ubah" id="ubah-jabatan">ubah</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('pengaturan/jabatan_ubah') ?>" method="post" id="formUbahJabatan">
                <div class="modal-body">
                    <!-- Hidden input untuk menyimpan ID yang akan diubah -->
