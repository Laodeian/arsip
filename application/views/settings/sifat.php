                                    ...
                                    <?php foreach ($sifat as $num => $s) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- Tombol membuka modal ubah -->
                                                <button type="button" data-toggle="modal" data-target="#ubahSifat" data-id="<?= $s['id']; ?>" data-sifat="<?= $s['sifat']; ?>" 
                                                class=" btn btn-sm btn-warning btn-modal btn-ubah">ubah</button>

                                                <!-- Tombol membuka modal hapus -->
