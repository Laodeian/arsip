                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <a href="<?= base_url('surat-masuk'); ?>" target="_blank" style="text-decoration: none; color: inherit;">Jumlah Surat Masuk</a> </div>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                <a href="<?= base_url('surat-keluar'); ?>" target="_blank" style="text-decoration: none; color: inherit;">Jumlah Surat Keluar</a></div>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                <a href="<?= base_url('pengaturan/klasifikasi'); ?>" target="_blank" style="text-decoration: none; color: inherit;">Jumlah Klasifikasi</a> </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
